...
================================
-run_ImageMRIDat_DVD.sh (shell script for temporarily setting environment variables and 
                         executing the application)
   -to run the shell script, type
   
       ./run_ImageMRIDat_DVD.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/R2024b, run the shell script as:
       ...
       ./run_ImageMRIDat_DVD.sh /mathworks/home/application/R2024b
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_ImageMRIDat_DVD.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
    Note: if end users are unable to download the MATLAB Runtime using the
    instructions in the previous section, include it when building your 
    component by clicking the "Runtime included in package" link in the
    Deployment Tool.
-The Macintosh bundle directory structure ImageMRIDat_DVD.app 
    Note: this can be stored in an archive file with the zip command 
    zip -r ImageMRIDat_DVD.zip ImageMRIDat_DVD.app
    or the tar command 
    tar -cvf ImageMRIDat_DVD.tar ImageMRIDat_DVD.app
-This readme file 
...
MR/R2024b/runtime/maci64:MR/R2024b/sys/os/maci64:MR/R2024b/bin/maci64

If it is defined, set it to the following:

${DYLD_LIBRARY_PATH}:MR/R2024b/runtime/maci64:MR/R2024b/sys/os/maci64:MR/R2024b/bin/maci64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_ImageMRIDat_DVD.sh 
